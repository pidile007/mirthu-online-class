...
<html lang="en">
  ...
  <body  onload="startTime()">
    ...
    <br><img src="https://res.cloudinary.com/pidile/image/upload/v1623662723/time_table.jpg"  alt="Not Found" onerror=this.src="assets/img/vivekam2.jpg" class="center">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="footer-text text-center">
              ...
              <p style="color:rgb(24, 24, 24);">V 2.6</p>
            </div>
          </div>
        </div>
      </div> 
